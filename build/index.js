...
var Identicon = function (_Component) {
    ...
    _createClass(Identicon, [{
        ...
        key: "updateCanvas",
        value: function updateCanvas(props) {
            var fg = props.fg,
                bg = props.bg,
                count = props.count,
                palette = props.palette;

            var hash = (0, _md2.default)(props.string);
            var block = Math.floor(props.size / count);

            if (palette && palette.length) {
                var palette_index = Math.floor(range(parseInt(hash.slice(-3), 16), 0, 4095, 0, palette.length));
                fg = palette[palette_index];
            }

            var pad = props.padding;
        ...
        value: function render() {
            return _react2.default.createElement("canvas", { ref: this.canvas, className: this.props.className, style: { width: this.props.size, height: this.props.size } });
        }
    }]);
